...
function MockPaymentContent() {
  ...
  if (!orderId) {
    return <div className="p-8 text-center text-white">Order ID is missing</div>;
  }
...
export default function MockPaymentPage() {
  return (
    <div className="min-h-screen bg-neutral-900 flex flex-col items-center justify-center p-4">
      <Suspense fallback={<div className="flex items-center justify-center"><Loader2 className="animate-spin text-white size-8" /></div>}>
        <MockPaymentContent />
      </Suspense>
    </div>
  );
